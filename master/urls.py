...
urlpatterns = [
    ...
    path('aspirantes/create/', views.PersonaCreateView.as_view(), name='aspirante_create'),
    path('aspirantes/<int:id>/', views.PersonaDetailView.as_view(), name='aspirante_detail'),
    path('aspirantes/<int:id>/edit/', views.PersonaUpdateView.as_view(), name='aspirante_edit'),
    path('aspirantes/<int:id>/delete/', views.PersonaDeleteView.as_view(), name='aspirante_delete'),
